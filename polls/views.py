...
def vote(request, question_id):
    ...
    try:
        # Choice is a key name here. Request.POST always returns a string value.
        ...
        # POST data. This prevents data from being posted twice if a user hits BACK
        # button.
        # ----- #
        # Reverse function helps avoid having to hard code a URL in the view function.
